...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      <Navigation scrollToAbout={scrollToAbout} scrollToContact={scrollToContact} />
      ...
      <div ref={aboutRef} className="flex flex-col items-center min-h-[80vh] w-3/5 pt-24">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full py-24">
          ...
          <div className="w-full md:w-1/2 md:pl-12 p-6 flex justify-center">
            <div 
              className="h-[600px] w-[500px] bg-fixed" 
              style={{ 
                backgroundImage: "url('/images/stage.png')",
                backgroundSize: "60%", // Keeps image filling the div
                backgroundPosition: "center", // Moves it to the right but keeps it centered vertically
      ...
      {/* contact container */}
      <div ref={contactRef} id="contact" className="flex flex-col items-center min-h-[80vh] w-3/5 pt-24">
        <p className="text-2xl font-roboto text-white tracking-[0.4em]">*****************</p>
        <h2 className="text-6xl font-prata text-white tracking-[0.4em] py-6">
          contact
        </h2>
